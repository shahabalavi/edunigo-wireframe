...
const EditTransitionModal = ({ transition, onClose, onUpdate, statuses, events }) => {
    ...
    <div className={styles["modal-overlay"]} onClick={handleBackdropClick}>
      <div className={styles["modal-container"]}>
        <div className={styles["modal-header"]}>
          <h3 className={styles["modal-title"]}>Edit Transition</h3>
          ...
          <div className={styles["form-group"]}>
            <label className={styles["toggle-row"]}>
              <input
                ...
                onChange={handleInputChange}
              />
              <span className={styles["toggle-label"]}>Active rule</span>
            </label>
          </div>
