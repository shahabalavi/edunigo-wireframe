...
const CreateMajorModal = ({ onClose, onSubmit }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrors({
        submit: "Failed to create major/field. Please try again.",
      });
    } finally {
      ...
      <div className={styles["modal-container"]}>
        <div className={styles["modal-header"]}>
          <div className={styles["header-left"]}>
            ...
            <div>
              <h2>Add New Major/Field</h2>
              <p>Create a new major/field entry</p>
            </div>
          </div>
