...
const DeleteConfirmationModal = ({ city, onClose, onConfirm }) => {
          ...
          <div className={styles["warning-section"]}>
            ...
            <div className={styles["warning-text"]}>
              ...
              <p>
                ...
                from <strong>"{city?.country?.name}"</strong>? This action
                cannot be undone.
              </p>
              <p className={styles["warning-note"]}>
                This will permanently remove the city and all associated data.
              </p>
            </div>
          </div>
        </div>
