...
const CreateCountryModal = ({ onClose, onSubmit }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrors({ submit: "Failed to create country. Please try again." });
    } finally {
        ...
        <div className={styles["modal-header"]}>
          <div className={styles["header-left"]}>
            ...
            <div>
              ...
              <p>Create a new country entry with codes and ISO information</p>
            </div>
          </div>
