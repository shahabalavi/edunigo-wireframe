    ...
    try {
      ...
      const submitData = {
        ...
        fields: fields.map((field) => ({
          ...
          options:
            field.type === "select" ? field.options.filter(Boolean) : null,
        })),
      };

      console.log("Creating document:", submitData);
      ...
      setErrors({
        submit: "Failed to create document. Please try again.",
      });
    } finally {
      ...
      <div className={styles["page-header"]}>
        <div className={styles["header-left"]}>
          ...
          <div>
            ...
            <p>Define a new document with custom fields</p>
          </div>
        </div>
      </div>
