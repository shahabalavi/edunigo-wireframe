...
const DeleteConfirmationModal = ({ major, onClose, onConfirm }) => {
        ...
        <div className={styles["delete-content"]}>
          <div className={styles["warning-section"]}>
            ...
            <div className={styles["warning-text"]}>
              <h3>Delete Major/Field</h3>
              <p>
                Are you sure you want to delete <strong>"{major?.name}"</strong>
