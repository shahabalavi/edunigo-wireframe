...
const DeleteConfirmationModal = ({ educationLevel, onClose, onConfirm }) => {
        ...
        <div className={styles["delete-content"]}>
          <div className={styles["warning-section"]}>
            ...
            <div className={styles["warning-text"]}>
              <h3>Delete Education Level</h3>
              <p>
                Are you sure you want to delete{" "}
                <strong>"{educationLevel?.name}"</strong>? This action cannot be
                undone.
              </p>
            </div>
          </div>
